...
## [1.52.0](https://github.com/psy-repos-linux/emp3r0r/compare/v1.51.1...v1.52.0) (2025-02-07)


### Features

* `file_downloader` that downloads files from agent hosted HTTP server, for data exfiltration, with checksum support ([969f153](https://github.com/psy-repos-linux/emp3r0r/commit/969f153ce72b6e4533d4f7cc682ff847887f5309))
* `file_server` for file transfer between agents ([ad83344](https://github.com/psy-repos-linux/emp3r0r/commit/ad833443cca7314be2980edd9e7a46427fb644c2))
* add ELF in-mem loader for Linux modules (WIP) ([5b62db8](https://github.com/psy-repos-linux/emp3r0r/commit/5b62db85f75f3b479153daf933a98f409a7bb47f))
* add http stager (with AES encryption) and independent HTTP listener ([66f4d8c](https://github.com/psy-repos-linux/emp3r0r/commit/66f4d8cc23a31381d57d93dec11478c7234fc87e))
...
* add Shadowsocks TCP tunnel support, can be used for port_fwd, C2 transport relaying ([bdf9f56](https://github.com/psy-repos-linux/emp3r0r/commit/bdf9f5680bb6fd40251400ebf021b60e1f378878))
* add standalone `elvish` cross-platform shell ([a97c51e](https://github.com/psy-repos-linux/emp3r0r/commit/a97c51eba89a14e43857ca475eab1af300132609))
* agent side "listener" for lateral movement and payload delivery ([c4b40b8](https://github.com/psy-repos-linux/emp3r0r/commit/c4b40b82f25f590da11c53cbcc11b300a7698dab))
* broadcasted auto_proxy is now using shadowsocks ([b31562b](https://github.com/psy-repos-linux/emp3r0r/commit/b31562b3eeea756679712a63e048725a795ad9eb))
...
* enable `upgrade_cc` command (WIP) ([63b2384](https://github.com/psy-repos-linux/emp3r0r/commit/63b23847233c0f1dbf501add32d46f5c26b3bccb))
* go_lpe ([fd524d0](https://github.com/psy-repos-linux/emp3r0r/commit/fd524d071dd0a2817f3abe2b73ee4b2fddf49273))
* improve module config structure ([e5dea79](https://github.com/psy-repos-linux/emp3r0r/commit/e5dea792a0df6f808349caa63ebca8dd774149c0))
* include listener in releases ([f96226d](https://github.com/psy-repos-linux/emp3r0r/commit/f96226d21d4f8c3bbacff2c1dfde95c3323c3787))
...
* process `mem_dump` for Linux and Windows ([b8a9822](https://github.com/psy-repos-linux/emp3r0r/commit/b8a98229b697104c2a95921375c2170c6c494aaf))
* support C2 plugins and module builder ([8eba6f5](https://github.com/psy-repos-linux/emp3r0r/commit/8eba6f5291108d0ad0883837de0980fc07506944))
...
* support DLL/SO payload types ([d8a1c04](https://github.com/psy-repos-linux/emp3r0r/commit/d8a1c0403c19d2e0aa21210eb55f80b8fb6ec7ae))
...
* support payload compression in stager ([97b271a](https://github.com/psy-repos-linux/emp3r0r/commit/97b271a9774cac8a15de58dd26727ab17034ff26))
* transparent zstd compression for file downloading from agents ([e4144c5](https://github.com/psy-repos-linux/emp3r0r/commit/e4144c5f543e9642411888169b76972143be8605))
...
* [#393](https://github.com/psy-repos-linux/emp3r0r/issues/393) use more precise binary patching for reliable config extraction ([88bda6d](https://github.com/psy-repos-linux/emp3r0r/commit/88bda6d25d78f9e860ac6a023b4e5b5e28f8cd48))
...
* `--debug` build fails ([0eac8a0](https://github.com/psy-repos-linux/emp3r0r/commit/0eac8a0e8aaf4c030f6e64bc068aec2716993223))
...
* `AddNeededLib` no longer depends on `patchelf` program ([5983def](https://github.com/psy-repos-linux/emp3r0r/commit/5983def174945d7204b79b9d8eb87a0f71bbe244))
* `bring2cc` accidentally disabled ([ec11524](https://github.com/psy-repos-linux/emp3r0r/commit/ec115249ff8b53499dc97010220eda577b78e81c))
...
* `elvish_win` not working ([2c3ef0d](https://github.com/psy-repos-linux/emp3r0r/commit/2c3ef0dfa9963e7abc1040d699d5cde8f6c530c3))
* `file_downloader` should have an option to opt out of checksum verification ([27529ff](https://github.com/psy-repos-linux/emp3r0r/commit/27529ff4ce4d9ec6089098ac07721142de73f12a))
* `file_manager` not starting ([8aee534](https://github.com/psy-repos-linux/emp3r0r/commit/8aee53450427457354d759023269a90ffa1a87e6))
* `file_server` http port should be random ([b570cd0](https://github.com/psy-repos-linux/emp3r0r/commit/b570cd0e5427a0c569a1c16964449e9a8da0033b))
* `gen_agent` module initialization ([d652b0e](https://github.com/psy-repos-linux/emp3r0r/commit/d652b0e48d85f14bbe1e1a5445322a425458a826))
...
* `get` download progress not showing ([4b349cc](https://github.com/psy-repos-linux/emp3r0r/commit/4b349cc82b6f53380888f88dc6c3d454e9ac2fcf))
* `go_lpe` takes too long ([fdd23b1](https://github.com/psy-repos-linux/emp3r0r/commit/fdd23b14c39064ccd0d010bcd928da2aa5aed6a6))
* `makeTransport` takes forever to fail, let's make it 10s top ([7ccb64b](https://github.com/psy-repos-linux/emp3r0r/commit/7ccb64b6db7b5b09b0b42ba91e8a08a8804a461b))
* `mem_dump` should download dumped mem file ([3221840](https://github.com/psy-repos-linux/emp3r0r/commit/32218402e6d53bbcb68ef2efb346076aeca22230))
...
* `ps` command output not parsed ([7ace03c](https://github.com/psy-repos-linux/emp3r0r/commit/7ace03c4d882db7980e63df0879f9daf8290d81f))
* `stager.so` non-debug build lacks AES support ([679b755](https://github.com/psy-repos-linux/emp3r0r/commit/679b755a50350e8814bebae6dd4698ff0e8b7d5f))
* `stager` module should be able to read configurations from env vars ([ce22a03](https://github.com/psy-repos-linux/emp3r0r/commit/ce22a03682cf40a8aaaf808313ef32184865defe))
...
* `upgrade_agent` not working ([ab296aa](https://github.com/psy-repos-linux/emp3r0r/commit/ab296aa6f1e639c33fc36b75c3de23d015a26c20))
* `vaccine` installation fails: `patchelf` not found ([315ec2b](https://github.com/psy-repos-linux/emp3r0r/commit/315ec2b38ba9f085ec1803989e6d79d966f315f7))
...
* add plain HTTP listener ([a480f30](https://github.com/psy-repos-linux/emp3r0r/commit/a480f306611afdaf10f114a84da4909c7f4e81e2))
* add some nil dereference check to improve stability ([6710ed7](https://github.com/psy-repos-linux/emp3r0r/commit/6710ed73f31fd58dba57af22733cad03ded32667))
* adjust logging text colors ([ba1c133](https://github.com/psy-repos-linux/emp3r0r/commit/ba1c133dfaf732a81cc8b49695744dfb1ca63d37))
* AES decryption in stager ([757a386](https://github.com/psy-repos-linux/emp3r0r/commit/757a386969f519c45fea5ec0802e6ea3fe0297ae))
...
* agent dies on unix socket error ([f0757fe](https://github.com/psy-repos-linux/emp3r0r/commit/f0757fe9127a04be0c7ee3c7ef724757853f06e1))
* agent path names ([2b2773a](https://github.com/psy-repos-linux/emp3r0r/commit/2b2773a084ced9ed172bee2426b9f1939486fffc))
* agent response too noisy ([123258a](https://github.com/psy-repos-linux/emp3r0r/commit/123258aef2b0bb2e46956d90339fe35ce2a9ce2a))
...
* agent root path searching ([aa0941c](https://github.com/psy-repos-linux/emp3r0r/commit/aa0941cc90ee4021d603c8aa75cbd3c55b44c022))
...
* agent wait queue ([28dadaa](https://github.com/psy-repos-linux/emp3r0r/commit/28dadaa76f4385bc13a52fdda0e9b5aad6782e73))
* agents get removed because commands timeout ([7fc8a23](https://github.com/psy-repos-linux/emp3r0r/commit/7fc8a236f9b2c4ab7708b0c1bdd8ffb7b7f08ec1))
...
* auto completion fix ([571fd0c](https://github.com/psy-repos-linux/emp3r0r/commit/571fd0c65d03971bc6645f40eb348965d7798287))
...
* build as `windowsgui` if target is Windows ([33ca2f6](https://github.com/psy-repos-linux/emp3r0r/commit/33ca2f6444ec6e99ab0b8486705167ee1133e41b))
* build: switch to `zstd` ([d7e1eeb](https://github.com/psy-repos-linux/emp3r0r/commit/d7e1eeb8d9b02c2a6e71cb8e4805e05fba8f657b))
* C2 CLI log is written to unexpected location ([332a96b](https://github.com/psy-repos-linux/emp3r0r/commit/332a96b91fc84ab03b7be5273ac5eec221d7cd5d))
* c2 commands refactor ([fb46ae8](https://github.com/psy-repos-linux/emp3r0r/commit/fb46ae8a3f3042b354139f0b0d9d0528321cef7a))
...
* change prompt style when having root access ([3a46fd6](https://github.com/psy-repos-linux/emp3r0r/commit/3a46fd6db3002a840c6aceaf62508d0326a8fcee))
...
* check if local version is already the latest ([0abb4a0](https://github.com/psy-repos-linux/emp3r0r/commit/0abb4a06a2bf7b2691d8b42836493b1feac321ca))
* check target OS compatibility before running modules ([aac0b85](https://github.com/psy-repos-linux/emp3r0r/commit/aac0b85b8771a4774dfc645efec10383c9645adf))
* CLI commands handling refactored ([394e5e4](https://github.com/psy-repos-linux/emp3r0r/commit/394e5e42d03c449c94235145bd419db410aeecfa))
* cli crash ([d65907a](https://github.com/psy-repos-linux/emp3r0r/commit/d65907aef1a5d31d95645cf80e5cde58789bc23e))
* collect module output ([40fd645](https://github.com/psy-repos-linux/emp3r0r/commit/40fd6458173ddd815d617e06cf2e0b9ed9fd353b))
* command auto-completion broken after selecting a target ([8583b2c](https://github.com/psy-repos-linux/emp3r0r/commit/8583b2ce1e61994b5bf08c94195bc3f1e7be85fe))
...
* consider `darwin` even we are not supporting it ([4a736e2](https://github.com/psy-repos-linux/emp3r0r/commit/4a736e2e6ce63cabb4c57985d0292247bac9b5d4))
* copilot deleted my code, fucking retard! ([4548470](https://github.com/psy-repos-linux/emp3r0r/commit/4548470b772de423f97bdb1fe97c58af91c5c3bd))
...
* crash when using local modules ([490f309](https://github.com/psy-repos-linux/emp3r0r/commit/490f309d6178be4c0676cfb77b915098babc7e5f))
* create `CGO`-enabled agent for DLL/SO types ([cd1ad3b](https://github.com/psy-repos-linux/emp3r0r/commit/cd1ad3b3523002d865822cfe059c8a7184c94f8a))
* critical bug: NCSI checking prevents proxied agents from getting online ([eaede74](https://github.com/psy-repos-linux/emp3r0r/commit/eaede74882b7e7694709bca940671104ddfb7003))
...
* deprecate `upx`, users should deliver compressed payloads by themselves ([d10a2f8](https://github.com/psy-repos-linux/emp3r0r/commit/d10a2f812743bb29cf41688ee28d34d8e60b7ad4))
...
* disable `daemonizae` in Windows ([0902b70](https://github.com/psy-repos-linux/emp3r0r/commit/0902b70acc643e1b2c879d7e19b4e49d4065b177))
...
* disable automatic `vaccine` download, it should be run when needed ([20037a4](https://github.com/psy-repos-linux/emp3r0r/commit/20037a40368efde4fce8d6686284062d6fbd76a0))
* disable damned `chunked encoding` ([b1b0a79](https://github.com/psy-repos-linux/emp3r0r/commit/b1b0a798f19621319f929684db5ed4fd6dd72f79))
* display `cd` errors ([59d5682](https://github.com/psy-repos-linux/emp3r0r/commit/59d568245bc9ad395d1ca397dc3904959dce5d62))
* distinguish types of modules for better handling ([4daebde](https://github.com/psy-repos-linux/emp3r0r/commit/4daebde60ffa41519680c763adf53363eb46d4ed))
...
* do not download again if already downloaded and checksum matched ([aa9ec97](https://github.com/psy-repos-linux/emp3r0r/commit/aa9ec976838e1693edc18f9548b4d464767efee8))
* do not download file when memdump fails ([2445006](https://github.com/psy-repos-linux/emp3r0r/commit/244500618e1a60da8865b0f4bf2e6bdf3d41de73))
...
* do not request full path to download ([55c463e](https://github.com/psy-repos-linux/emp3r0r/commit/55c463e028f0b283f81e2fe86e7449f206a7977e))
* dont print binary data to the terminal ([f3603a2](https://github.com/psy-repos-linux/emp3r0r/commit/f3603a2008cad27480d0871b028c2104206f4869))
...
* drop `-s` when building debug version ([20e11e5](https://github.com/psy-repos-linux/emp3r0r/commit/20e11e51f76e505d93ac57eaffcea4b23f7ab8b6))
* ELF header parser ([c037902](https://github.com/psy-repos-linux/emp3r0r/commit/c0379023ad40f6b633600f7465034fd12de3b195))
* eliminate wait for all commands ([2d004fd](https://github.com/psy-repos-linux/emp3r0r/commit/2d004fdf47924af7bb0c926ce7310fd1c86c0fa3))
* exec system commands with args ([e41875f](https://github.com/psy-repos-linux/emp3r0r/commit/e41875f63ae11b56091d5028c9f78bc1e30a4665))
...
* fs commands ([4336af2](https://github.com/psy-repos-linux/emp3r0r/commit/4336af211d554edaf8644cc978b6167e442f12b6))
* go-console fails to build for arm64 ([5faa4fc](https://github.com/psy-repos-linux/emp3r0r/commit/5faa4fcd78257448012ba18e4fdce5980767f4ce))
* handling of compression of in-mem modules ([47c20ae](https://github.com/psy-repos-linux/emp3r0r/commit/47c20ae849619a703e9d95c815f8c7aece278113))
* handling of in-memory script modules ([f22163a](https://github.com/psy-repos-linux/emp3r0r/commit/f22163a524dd16d9b1abe404fdc73b6a7aacc2f5))
* high CPU usage by emp3r0r-cat (probably related to [#315](https://github.com/psy-repos-linux/emp3r0r/issues/315)) ([7854a07](https://github.com/psy-repos-linux/emp3r0r/commit/7854a070d9bccd6eec582d7ea716e497a993a455))
...
* improve command parsing ([e5baccb](https://github.com/psy-repos-linux/emp3r0r/commit/e5baccb4ffd3d49dcee27b3c8434bcd538489dc3))
* improve downloading from C2, add checksum verification ([459bdab](https://github.com/psy-repos-linux/emp3r0r/commit/459bdabbc25187704f1be880f814a2087f5824d1))
* improve module management and code refactoring ([656a652](https://github.com/psy-repos-linux/emp3r0r/commit/656a652b7c4e5776bbcf0cc4a06f3d80491cef0e))
...
* installer not run when updating CC ([b0f25de](https://github.com/psy-repos-linux/emp3r0r/commit/b0f25de2deefd6ac440b0774d86a4ebcfd373699))
* int overflow and build issue ([6fe9ee3](https://github.com/psy-repos-linux/emp3r0r/commit/6fe9ee365888b65a6d5abc7c89722d75a28e34e9))
* interactive modules "failed to upload" ([924dbca](https://github.com/psy-repos-linux/emp3r0r/commit/924dbcaaea0217f095bada162171473d7842cbae))
* interactive modules file not found in Windows ([7d2e4c8](https://github.com/psy-repos-linux/emp3r0r/commit/7d2e4c82e20484a7edc30f7b7d0f73e2ed6e5fb4))
* interactive modules not opening ([7ccbefb](https://github.com/psy-repos-linux/emp3r0r/commit/7ccbefbcc978d6c1b7e3cd709063492766c339a2))
* KCPClient should exit when reverse proxy session ends ([51d02e4](https://github.com/psy-repos-linux/emp3r0r/commit/51d02e4e0f8a64b3b5639d201a747a15cf36c550))
* linux shared libs linked with musl seems broken ([360efe8](https://github.com/psy-repos-linux/emp3r0r/commit/360efe8fbe98075496a7add013b660c0732af9d6))
* log filename ([8dff46a](https://github.com/psy-repos-linux/emp3r0r/commit/8dff46aa369092b8f20f7ad03aaf8950ab8adaf4))
* logging not working ([6fc43f1](https://github.com/psy-repos-linux/emp3r0r/commit/6fc43f1ae441f79bac72e6138ed962aae9fa8efd))
...
* make it possible to download modules from specified agent file server ([4f178b5](https://github.com/psy-repos-linux/emp3r0r/commit/4f178b5f11b6c150498e26aa730302a3de3275b6))
* make prompt string more informative ([7e432d2](https://github.com/psy-repos-linux/emp3r0r/commit/7e432d260f28c26896f750648a343cec4857bdca))
* make sure stdin closes ([a328ea8](https://github.com/psy-repos-linux/emp3r0r/commit/a328ea8cf1acbbfe67cd4874f570f2997725b64a))
* make use of `is_local` attribute ([2a80931](https://github.com/psy-repos-linux/emp3r0r/commit/2a809310863443a037da6cea1d84d8cf93d0b260))
* messy logging in kcptun ([ea2aa88](https://github.com/psy-repos-linux/emp3r0r/commit/ea2aa885718ab3fa0388ba37164651a8723ac2d2))
...
* module builder ([2751c49](https://github.com/psy-repos-linux/emp3r0r/commit/2751c499a08ceac6cb96f8f1d85556391e9a713b))
* module path handling ([0a375c8](https://github.com/psy-repos-linux/emp3r0r/commit/0a375c8d1e36d5f36003d1e2440a621e957c4d65))
...
* modules should not block ([1655958](https://github.com/psy-repos-linux/emp3r0r/commit/16559587f1678467a82a5f689a2a33c8961876c7))
...
* ncsi switch broken ([90fe415](https://github.com/psy-repos-linux/emp3r0r/commit/90fe415433a7e27700c7c05c0d6652f84d8d2757))
* need a reliable way to check if the agent is run as DLL ([330a0b6](https://github.com/psy-repos-linux/emp3r0r/commit/330a0b6a4db441b20d0fc1f171260e792138eb2c))
...
* no CGO when building executables ([4d73434](https://github.com/psy-repos-linux/emp3r0r/commit/4d73434a0dc66d61f47a5ba9565438fad7edf80d))
...
* no need to keep validating the reverse proxy when a working proxy is configured ([144ca1e](https://github.com/psy-repos-linux/emp3r0r/commit/144ca1e61fd0ede635cdedddfa7804419c85996b))
* no output from `stager` ([51a99ff](https://github.com/psy-repos-linux/emp3r0r/commit/51a99ff33db81914671e9a0233f3f21d82e08e8c))
...
* only extract `bashrc` when needed ([d51e78c](https://github.com/psy-repos-linux/emp3r0r/commit/d51e78c8d4b96748417c271c9abb23b0742985da))
* open sftp in new tmux window to save space ([c29b8c1](https://github.com/psy-repos-linux/emp3r0r/commit/c29b8c15115d8f53c42652ba743442c24c275bfe))
* optimize custom module handler ([e27a6df](https://github.com/psy-repos-linux/emp3r0r/commit/e27a6df8ae38bebdba2302cbdb352dd6fef08f82))
...
* port_fwd should print some feedback ([1c6844f](https://github.com/psy-repos-linux/emp3r0r/commit/1c6844f53eeab5f81a95c8702060bd64dc180966))
* possible crash ([e568438](https://github.com/psy-repos-linux/emp3r0r/commit/e56843899a3b086eddf670b9d50ea142fda95f65))
* program header parser should run only once ([7c8940a](https://github.com/psy-repos-linux/emp3r0r/commit/7c8940af4e24505a7c612ba6ee9cf6b78f088e6b))
* python modules broken ([11995cb](https://github.com/psy-repos-linux/emp3r0r/commit/11995cb593051387f173fe256d7fd21282ff0897))
* randomize `MagicString` ([4bf2f96](https://github.com/psy-repos-linux/emp3r0r/commit/4bf2f9666f443b1bc8503fdf8ad00a43b8286245))
...
* randomize proxyDialer sleep time ([aa212d5](https://github.com/psy-repos-linux/emp3r0r/commit/aa212d5610e5c23a31d4a175a2451a34246e6006))
...
* recursive `get`, useful when downloading a directory on a target ([36696e5](https://github.com/psy-repos-linux/emp3r0r/commit/36696e55e4dda23433d7310a92f04465ac687ae9))
* recursive dowloads should retain directory structure ([20d8bda](https://github.com/psy-repos-linux/emp3r0r/commit/20d8bda469ec138a7bb15c27e943ec17e97c7869))
* redesign modules and fix errors ([c90ed00](https://github.com/psy-repos-linux/emp3r0r/commit/c90ed0013105eed9f360466fca3e0f1a8823c9d4))
* reduce CPU load ([2f5ed34](https://github.com/psy-repos-linux/emp3r0r/commit/2f5ed34f72ca41d44d2e08a8747307a9ba631fa3))
* reduce embeded file size using xz ([79f76e1](https://github.com/psy-repos-linux/emp3r0r/commit/79f76e17a677a7e632d904aa4d3a26d55c10e6e9))
* redundant port mappings for SSH shells ([7c0da2b](https://github.com/psy-repos-linux/emp3r0r/commit/7c0da2b864356d853bf84880213c5cf7e2ee5df0))
* refactor C code, integrate `stager` into one of the modules ([a53f78c](https://github.com/psy-repos-linux/emp3r0r/commit/a53f78cd310eb0f1e10b0976d715f76d063f60ad))
* refactor module config structure ([bf38b05](https://github.com/psy-repos-linux/emp3r0r/commit/bf38b05e6e7a3c4d244f61ad591fc46b25e2e796))
...
* regex filter for recursive downloads ([1443b01](https://github.com/psy-repos-linux/emp3r0r/commit/1443b0144fb6eadef89b385f57ca44ac86a4a3a8))
...
* remove `go-lpe` as it's not very useful ([756d4ed](https://github.com/psy-repos-linux/emp3r0r/commit/756d4eddc43469c5f79e9aacce60c41eb03149bf))
...
* restrict to 1 task per download for recursive downloads, enforce checksum verification ([7f66130](https://github.com/psy-repos-linux/emp3r0r/commit/7f661306352711898fb655b187f034e1435aae59))
* return process output of in-memory ELF modules ([63cd991](https://github.com/psy-repos-linux/emp3r0r/commit/63cd9914d9d01485c1a1bb6d8bd1352a83f8a3c8))
* run ELF in subroutine ([91279bf](https://github.com/psy-repos-linux/emp3r0r/commit/91279bff261857c28ac9321dc3bbcbbfbd3164d4))
* save agents' output to a log file ([d1b19f7](https://github.com/psy-repos-linux/emp3r0r/commit/d1b19f7115b3381221fb265be2618962e4c227a0))
* set env vars for module builder ([ba3a10a](https://github.com/psy-repos-linux/emp3r0r/commit/ba3a10a84b36a75afed49bc6534732948ffe2434))
* should check if any files fail to download in recursive downloads ([08427dd](https://github.com/psy-repos-linux/emp3r0r/commit/08427dd67e26df19734503bdaaf7b839b4854dd5))
* should report C2 transport proxy if it's used ([4519725](https://github.com/psy-repos-linux/emp3r0r/commit/45197252ee8b4c3f76dfed743f40c120c5f92767))
...
* socket listener not running ([26802d0](https://github.com/psy-repos-linux/emp3r0r/commit/26802d0630be8b2e0cd366526325d739c73cc0d5))
...
* sometimes agent can't send back response ([d1a0388](https://github.com/psy-repos-linux/emp3r0r/commit/d1a03883ef1cc9c026d73740928a271cc62070ee))
...
* ssh reverse proxy in KCP mode: client port should be renewed with each session ([e8b2649](https://github.com/psy-repos-linux/emp3r0r/commit/e8b26490e81dcf61968eaf1fb8c9bcae78188c99))
* ssh reverse proxy in KCP tunnel now working ([30935fc](https://github.com/psy-repos-linux/emp3r0r/commit/30935fc71b5440c4330f617f8ab3c12118a1264a))
* support more arch for shared obj building ([dd16baa](https://github.com/psy-repos-linux/emp3r0r/commit/dd16baa2b2dc75979689d1daefe6f3e23bcbd3c8))
* support more arch when building `linux_so` ([9a39895](https://github.com/psy-repos-linux/emp3r0r/commit/9a39895797f9e3c4f20a14cb129fb7c14ccadc40))
...
* turn off NCSI by default ([b4c4940](https://github.com/psy-repos-linux/emp3r0r/commit/b4c4940f640a6cf31bf04c99ea414131bec830ae))
...
* UI adjustments and code refactor ([f6b2d00](https://github.com/psy-repos-linux/emp3r0r/commit/f6b2d00df39a06dbe23a911767bf6aa8ec3794cf))
* unable to find agent executable file when run from loaders (eg. shared lib) ([1140a3b](https://github.com/psy-repos-linux/emp3r0r/commit/1140a3bc56e08c41f66b30eb9383138b6a6d5af1))
...
* unable to run from ELF loader if `VERBOSE` is `false` ([ad9aab2](https://github.com/psy-repos-linux/emp3r0r/commit/ad9aab27f463bd7bb7581c0f63e16d1479ac9709))
...
* unix socket listener may fail when path name is too long ([d7c0e98](https://github.com/psy-repos-linux/emp3r0r/commit/d7c0e98415eccd1d090f9ebf2d0675488e21fb00))
* unix socket not set up ([313b4c9](https://github.com/psy-repos-linux/emp3r0r/commit/313b4c92538a200b2a21645813d69eab2cb0b22b))
* unix socket path not match ([3e67009](https://github.com/psy-repos-linux/emp3r0r/commit/3e67009dcbb23f3fb10825a1095837934c32a27c))
* update `gen_agent` help ([5db7099](https://github.com/psy-repos-linux/emp3r0r/commit/5db7099eb6ee8530ac7a2ac44242e474611ea6a9))
...
* update deps, remove deprecated `go-ps` ([94812c3](https://github.com/psy-repos-linux/emp3r0r/commit/94812c372c5298234f7b5c677825050a13e8d00f))
...
* upload checksum file to release ([8d49717](https://github.com/psy-repos-linux/emp3r0r/commit/8d4971750473e6a4d04e59636d379e8f73559b99))
* use `tmux-256color` as recommended by tmux documentation ([08da828](https://github.com/psy-repos-linux/emp3r0r/commit/08da828726c7620eeaa1e6b9ca74755482c90eff))
* use `zig` to avoid cross-compiling nightmare ([a919132](https://github.com/psy-repos-linux/emp3r0r/commit/a919132a8c71eaf24bb6512106f0fc79b73cc11d))
...
* use minidump on Windows to be more useful ([e5f7ae2](https://github.com/psy-repos-linux/emp3r0r/commit/e5f7ae296b0526343fef0bb69218d36a853d9af4))
...
* verify encrypted config data before using ([f716bc6](https://github.com/psy-repos-linux/emp3r0r/commit/f716bc689cdbdf5f7fdcc23c47c1bb12b364a8b6))
* version number not updating ([5732f25](https://github.com/psy-repos-linux/emp3r0r/commit/5732f253782a08f71b12cc8355bff5ecc8295e07))
